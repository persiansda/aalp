<template>
  <div z-0 class="absolute dark:hidden inset-x-0 top-[-10rem] transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]">
    <svg id="bg-svg" class="relative left-1/2 -z-10 h-[21.1875rem] max-w-none -translate-x-1/2 rotate-[30deg] sm:left-[calc(50%-40rem)] sm:h-[42.375rem]" viewBox="0 0 1155 678">
...
<style>
#bg-svg {
  animation: bg-svg 10s linear infinite;
}
